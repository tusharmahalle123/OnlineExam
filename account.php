...
$time=60*$time;
header( "refresh:$time;url=result.php" );
...
// echo "<span><div id='starttime'></div>

//             <div id='showtime'></div>
// </span>";

echo '<div id="starttime" style="margin-left:58px" "padding:10px">
<button type="input" class="btn btn-danger" style="margin-bottom:;margin-bottom: 12px;"><div id="showtime"></div></button>
</div>
';
...
f1();
       function f1() {
        ...
        function f2() {
            if (parseInt(sec) > 0) {
                sec = parseInt(sec) - 1;
                document.getElementById("showtime").innerHTML = ""+hour+" hours : "+min+" Minutes : " + sec+" Seconds";
...
echo '<div style="margin-left:58px;">
...
echo '<form action="update.php?q=quiz&step=2&eid='.$eid.'&n='.$sn.'&t='.$total.'&qid='.$qid.'" method="POST" class="form-horizontal" id="myForm">
<br />';
...
echo "<input type='hidden' name='time' id='remt'>";
echo'<br /><button type="button" onclick="sendData()" class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Submit</button></form></div>';
//header("location:dash.php?q=4&step=2&eid=$id&n=$total");
?>
<script type="text/javascript">
  function sendData(){
    let remainingt = document.getElementById("showtime").innerHTML;
    document.getElementById('remt').value = remainingt;
    document.getElementById("myForm").submit();}

    function sendData2(){
    let remainingt = document.getElementById("showtime").innerHTML;
    location.href="setsession.php?time="+remainingt;
  }
</script>
<?php
}
